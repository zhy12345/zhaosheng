...
<head>
  ...
  <meta name="format-detection" content="telephone=no"> 
	<link rel="stylesheet" type="text/css" href="<%=basePath %>/assets1/common/layui/css/layui.css" media="all">
	<link rel="stylesheet" type="text/css" href="<%=basePath %>/assets1/common/bootstrap/css/bootstrap.css" media="all">
	<link rel="stylesheet" type="text/css" href="<%=basePath %>/assets1/common/global.css">
	<link rel="stylesheet" type="text/css" href="<%=basePath %>/assets1/css/main.css" media="all">
</head>
<body>
...
<script type="text/javascript" src="assets1/common/layui/layui.js"></script>
...
<script type="text/javascript" src="assets1/jsplug/echarts.min.js"></script>
