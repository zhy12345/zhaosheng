...
<body>
    <div class="top">
     ...
     <div style="margin-top: 70px;"></div>
        <div class="span_nav">
             <span >当前位置：<a href="home.jsp">招生信息网</a>&gt;&gt;&gt;<a href="recruit_students_general_rules.jsp">招生简章</a></span>
        </div>
    <div id="body">
            ...
            <div class="body_left">
                ...
                <ul id="adminTbody">
	                <c:forEach items="${newslist }" var = "news">
	                    <a href="zsjzdetail.shtml?id=${news.id }&type=${news.type}">
	                    <li><p style="width:480px; overflow:hidden; white-space:nowrap; text-overflow:ellipsis;"> ${news.subject }</p><span>${news.time }</span></li>
	                    </a>
	                 </c:forEach>   
                </ul>
                 <form action="getzsjz.shtml" method="post" id="queryform" class="form-inline">
              		  <input type="hidden" name="page" id="page"> <input type="hidden" name="limit" id="limit">
                		<input type="hidden" name="type" id="招生简章">
                </form>
        ...
        <div class="body_right" style="width:280px">
