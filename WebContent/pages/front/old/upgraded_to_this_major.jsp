...
<body>
    <div class="top">
     ...
     <div style="margin-top: 70px;"></div>
        <div class="span_nav">
             <span >当前位置：<a href="major.jsp">招生信息网</a>&gt;&gt;&gt;<a href="major.jsp">专业介绍</a>&gt;&gt;&gt;<a href = "upgraded_to_this_major.jsp">专升本专业</a></span>
        </div>
    <div id="body">
            ...
            <div class="body_left">
                ...
                <ul id="adminTbody">
                 ...
                 <form action="zsbmajor.shtml" method="post" id="queryform" class="form-inline">
