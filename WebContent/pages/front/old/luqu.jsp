...
<body>
    <div class="top">
        ...
        <div class="span_nav">
             <span >当前位置：<a href="home.jsp">招生信息网</a>&gt;&gt;&gt;<a href="">录取分数线</a></span>
        </div>
    <div id="body">
            <div class="body_left">
                <h3>往年录取分数线</h3>
                ...
                <c:forEach items="${excellist }" var="list">
                  	  <a href="load.shtml?id=${list.id }&filepath=${list.filepath }"><li> ${list.filename } <span>下载次数：${list.downloadnum } </span></li></a>
                    </c:forEach>
                </ul>
                <form action="getzsjhexcel.shtml" method="post" id="queryform" class="form-inline">
              		  <input type="hidden" name="page" id="page"> <input type="hidden" name="limit" id="limit">
              		  <input type="hidden" name="exceltype" value="招生计划">
                </form>
        ...
        <div class="body_right">
                <img alt="" src="images/创造太阳.png" >
                <h4>欢迎报考中国石油大学胜利学院</h4>
                <p>扫码关注公众号</p>
                 <img src="images/index.jpg" alt="" id="im" />
