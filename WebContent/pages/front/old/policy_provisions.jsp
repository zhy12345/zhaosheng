...
<body>
    <div class="top">
     ...
     <div style="margin-top: 70px;"></div>
        ...
        <div class="span_nav">
            <span >当前位置：<a href="home.jsp">招生信息网</a>&gt;&gt;&gt;<a href="policy_provisions.jsp">政策规定</a></span>
        </div>
    <div id="body">
            <div class="body_left">
                <h3>政策规定</h3>
              <ul id="adminTbody">
                <c:forEach items="${newslist }" var="news">
                     <a href="zcgddetail.shtml?id=${news.id }&type=${news.type}">
                    <li><p style="width:480px; overflow:hidden; white-space:nowrap; text-overflow:ellipsis;"> ${news.subject }</p>
                    <span>${news.time }</span></li>
                    </a>
                  </c:forEach>
                </ul>
                 <form action="getzcgd.shtml" method="post" id="queryform" class="form-inline">
              		  <input type="hidden" name="page" id="page"> <input type="hidden" name="limit" id="limit">
                 	<input type="hidden" name="type" value="政策规定"> 
                </form>
