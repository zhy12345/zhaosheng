...
<body>
    <div class="top">
     ...
     <div style="margin-top: 70px;"></div>
        <div class="span_nav">
             <span >当前位置：<a href="main.shtml">招生信息网</a>&gt;&gt;&gt;<a href="major.jsp">专业介绍</a>&gt;&gt;&gt;<a href="specialized_subject.jsp">专科专业</a></span>
        </div>
    <div id="body">
            ...
            <div class="body_left">
                ...
                <form action="zkmajor.shtml" method="post" id="queryform" class="form-inline">
