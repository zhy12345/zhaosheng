...
<html lang="en">
<head>
<title>招生政策--中国石油大学胜利学院招生信息网</title>
				...
				<div class="l_con">
					...
					<div class="right">
						<ul class="news_list_1">
							    <c:forEach items="${riLiList}" var = "list">
									<li>
										<div class="tit">
											<a href="javaScript:void(0);">${list.subject}</a>
										</div>
										<div class="date"><fmt:formatDate pattern="yyyy-MM-dd" value="${list.addtime }"/></div>
									</li>
								</c:forEach>
									
							</ul>
							<form action="riLiDetail.shtml" method="post" id="queryform" class="form-inline">
