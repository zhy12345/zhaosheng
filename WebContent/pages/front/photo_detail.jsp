...
<input type="hidden" name="CSRFToken" value="9f3e4657-a2c1-4278-8c0b-134fd15abc36" />
    ...
    <div class="body">
            ...
            <div class="sec_1">
                <div class="l_con">
                    <div class="site_addr">
                        <div class="tit">照片查看</div>
                        <div class="addr">
                            <div>
                                <a href="<%=basePath %>/resources/f.htm" tppabs="https://zhaosheng.upc.edu.cn/f"><i class="icon_home"></i>首页</a>
                                <span class="icon_line">-</span>
                                <a href="list-c1009811e234444598ee3573956c0519.htm" tppabs="https://zhaosheng.upc.edu.cn/f/list-c1009811e234444598ee3573956c0519.htm">照片查看</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="news_wrap">
                <div class="l_con">
                    <div class="news">
                        ...
                        <div class="line"></div>
                        <div class="detail">
                            <p><img alt="" src="<%=filepath %>${photo.photopath}" style="width: 1200px; height: 800px;" /></p>
                        </div>
                    </div>
                </div>
            </div>
