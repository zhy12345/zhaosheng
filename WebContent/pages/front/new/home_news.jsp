...
<input type="hidden" name="CSRFToken" value="" />
						...
						<ul>
						    <li><a  href="../f.htm" tppabs="http://zhaosheng.upc.edu.cn/">首页<div class="dot"></div>
								...
								<li><a  target="_blank" href="http://www.upc.edu.cn/xygk/xxjj.htm">胜院简介<div class="dot"></div>
									</a></li>
								...
								<li>
									    <a href="javascript:vodi(0);">魅力胜院<div class="dot"></div>
									    </a>
										<ul class="subs">
										    <li><a  href="list-c1009811e234444598ee3573956c0519.htm" tppabs="https://zhaosheng.upc.edu.cn/f/list-c1009811e234444598ee3573956c0519.htm">图说胜院</a></li>
											<li><a  href="movielist-c119b36dbbe44fc2b461307428058ab5.htm" tppabs="https://zhaosheng.upc.edu.cn/f/movielist-c119b36dbbe44fc2b461307428058ab5.htm">视听胜院</a></li>
											</ul>
									</li>
							    </ul>
					</div>
    ...
    <div class="body">
            ...
            <div class="news_wrap">
                <div class="l_con">
                    <div class="news">
                        <div class="tit">${news.subject }</div>
                        <div class="info">
	                        <span>
	                                                                            供稿单位：
	                               ${news.author }
	...
	<script type="text/javascript" src="../static/front/upc/basic/js/util.js" tppabs="https://zhaosheng.upc.edu.cn/static/front/upc/basic/js/util.js"></script>
    <script type="text/javascript" src="../static/front/upc/basic/js/plugs.js" tppabs="https://zhaosheng.upc.edu.cn/static/front/upc/basic/js/plugs.js"></script>
    <script type="text/javascript">
				...
				<div class="l_con">
					<div class="chunk_1">
						<a href="javascript:void(0);"> <img class="logo"
							src="../static/front/upc/basic/images/index/logo_1.png" tppabs="https://zhaosheng.upc.edu.cn/static/front/upc/basic/images/index/logo_1.png" />
						</a>
					</div>
					<div class="chunk_2">
					...
					<div class="chunk_4">
						<div class="code1">
							<img src="../static/front/upc/basic/images/index/code_1.png" tppabs="https://zhaosheng.upc.edu.cn/static/front/upc/basic/images/index/code_1.png" />
							<div class="txt">本科招生微信</div>
						</div>
						<div class="code2">
							<img src="../static/front/upc/basic/images/index/code_2.png" tppabs="https://zhaosheng.upc.edu.cn/static/front/upc/basic/images/index/code_2.png" />
