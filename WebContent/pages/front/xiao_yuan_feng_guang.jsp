						...
						<div class="addr">
							<div>
								<a href="<%=basePath %>/resources/f.htm" tppabs="https://zhaosheng.upc.edu.cn/f"><i class="icon_home"></i>首页</a> <span
									...
									class="icon_arrow_right">></span> <a class="active" href="javascript:void(0);">图说胜院</a>
						...
						<div class="b_subNav">
							...
							<ul class="nav_a">
                                    ...
                                    <li class="active">
                                        <div class="nav_tit">
                                            <div>
                                                <a href="<%=basePath %>getXYFGPhoto.shtml">校园风光</a>
                                            </div>
                                        </div>
                                    </li>
	                                  <li class="">
	                                        <div class="nav_tit">
	                                            <div>
	                                                <a href="<%=basePath %>getYXXCPhoto.shtml">院系宣传</a>
	                                            </div>
	                                        </div>
	                                    </li>
                                    <li class="">
                                        <div class="nav_tit">
                                            <div>
                                                <a href="<%=basePath %>getVideoList.shtml">视听胜院</a>
                                            </div>
                                        </div>
                                    </li>
					...
					<div class="right">
							...
							<ul class="news_list">
									<c:forEach items="${photoList}" var="list">
										<li><a href="<%=basePath %>getPhotoDetail.shtml?id=${list.id}" class="img"> <img
												src="<%=filepath %>${list.photopath}" />
										    </a>
											<div class="txt">
												<a href="#">${list.sign}</a>
											</div>
							...
							<form action="getXYFGPhoto.shtml" method="post" id="queryform" class="form-inline">
